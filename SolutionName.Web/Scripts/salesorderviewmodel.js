...
SalesOrderViewModel = function (data) {
    ...
    ko.mapping.fromJS(data, salesOrderItemMapping, self),
        ...
        self.addSalesOrderItem = function () {
            var salesOrderItem = new SalesOrderItemViewModel({ SalesOrderItemId: 0, ProductCode: "", Quantity: 1, UnitPrice: 0.00, ObjectState: ObjectState.Added });
    ...
    self.deleteSalesOrderItem = function (salesOrderItem) {
        ...
        if (self.SalesOrderItemId() > 0 && self.SalesOrderItemsToDelete.indexOf(salesOrderItem.SalesOrderItemId()) == -1) {
